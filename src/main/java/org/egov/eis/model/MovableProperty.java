...
public class MovableProperty {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof MovableProperty))
			return false;
		MovableProperty other = (MovableProperty) obj;
		if (createdBy == null) {
	...
	public String toString() {
		return "MovableProperty [id=" + id + ", description=" + description + ", modeOfAcquisition=" + modeOfAcquisition
				+ ", permissionObtained=" + permissionObtained + ", originalValue=" + originalValue + ", orderNo="
				+ orderNo + ", orderDate=" + orderDate + ", documents=" + Arrays.toString(documents) + ", createdBy="
